...
import Module7Registration from './components/Module7Registration';
      ...
      <PreRegistrationProvider>
        <Router>
          <div className="App">
            <Navbar />
            <Routes>
              {/* Main Landing - Module 7 Registration */}
              <Route path="/" element={<Module7Registration />} />
              
              {/* Home Page - Module Selection */}
              <Route path="/home" element={<ModuleLanding />} />
